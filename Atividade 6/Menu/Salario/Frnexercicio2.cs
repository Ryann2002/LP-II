...
namespace Salario
{
    public partial class Frnexercicio2 : Form
    {
        ...
        private void test_equals_Click(object sender, EventArgs e)
        {
        ...
        private void insertinthetwo_Click(object sender, EventArgs e)
        {
            int meio = txtPalavra2.Text.Length / 2;
            txtPalavra2.Text = txtPalavra2.Text.Substring(0, meio) + txtPalavra1.Text + txtPalavra2.Text.Substring(meio);
        }
    }
}
